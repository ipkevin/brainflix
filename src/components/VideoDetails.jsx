        ...
        <main>
          <article className="description">
            ...
            <section className="description__credits">
              ...
              <p className="description__views"><img className="description__views-icon" src={viewsIcon} alt="view icon" />{props.selectedVideo.views}</p>
              <p className="description__date">{new Date(props.selectedVideo.timestamp).toLocaleDateString()}</p>
              <p className="description__likes"><img className="description__likes-icon" src={likesIcon} alt="Likes icon" />{props.selectedVideo.likes}</p>
            </section>
